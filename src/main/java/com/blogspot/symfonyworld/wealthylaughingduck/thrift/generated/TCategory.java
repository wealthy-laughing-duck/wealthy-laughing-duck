...
public class TCategory implements org.apache.thrift.TBase<TCategory, TCategory._Fields>, java.io.Serializable, Cloneable {
  ...
  public TCategory setParent_id(int parent_id) {
  ...
  public int compareTo(TCategory other) {
    ...
    TCategory typedOther = (TCategory)other;
