...
public class TOutcome implements org.apache.thrift.TBase<TOutcome, TOutcome._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TOutcome");
  ...
  static {
    schemes.put(StandardScheme.class, new TOutcomeStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TOutcomeTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TOutcome.class, metaDataMap);
  }
   ...
   */
  public TOutcome(TOutcome other) {
  ...
  public TOutcome setAmount(double amount) {
    this.amount = amount;
    setAmountIsSet(true);
    return this;
  }
  ...
  public TOutcome setUser(String user) {
    this.user = user;
    return this;
  }
  ...
  public TOutcome setCategory(String category) {
    this.category = category;
    return this;
  }
  ...
  public TOutcome setComment(String comment) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TOutcome)
      return this.equals((TOutcome)that);
    return false;
  }

  public boolean equals(TOutcome that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TOutcome other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TOutcome typedOther = (TOutcome)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TOutcome(");
    boolean first = true;
  ...
  private static class TOutcomeStandardSchemeFactory implements SchemeFactory {
    public TOutcomeStandardScheme getScheme() {
      return new TOutcomeStandardScheme();
    }
  }

  private static class TOutcomeStandardScheme extends StandardScheme<TOutcome> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TOutcome struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOutcome struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TOutcomeTupleSchemeFactory implements SchemeFactory {
    public TOutcomeTupleScheme getScheme() {
      return new TOutcomeTupleScheme();
    }
  }

  private static class TOutcomeTupleScheme extends TupleScheme<TOutcome> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TOutcome struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TOutcome struct) throws org.apache.thrift.TException {
