...
class MainServiceClient implements \SymfonyWorld\MainServiceIf {
  ...
  {
    $args = new \SymfonyWorld\MainService_add_args();
    $args->n1 = $n1;
    $args->n2 = $n2;
  ...
  public function recv_add()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\SymfonyWorld\MainService_add_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \SymfonyWorld\MainService_add_result();
  ...
  {
    $args = new \SymfonyWorld\MainService_sub_args();
    $args->n1 = $n1;
    $args->n2 = $n2;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
  ...
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\SymfonyWorld\MainService_sub_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \SymfonyWorld\MainService_sub_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
